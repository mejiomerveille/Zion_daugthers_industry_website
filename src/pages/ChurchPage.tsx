        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              '/images/im6.jpeg',
              '/images/im1.jpeg',
              '/images/article/pr.jpeg',
              '/images/article/me.jpeg',
              '/images/article/m1.jpeg',
              '/images/article/m2.jpeg',
              '/images/article/m4.jpeg',
              '/images/article/m5.jpeg',
              '/images/article/m6.jpeg',
              '/images/article/m3.jpeg',
              '/images/article/may.jpeg',
              '/images/article/may2.jpeg',
              '/images/article/me2.jpeg',
              '/images/article/m7.jpeg',
              '/images/article/m8.jpeg',
              '/images/article/m9.jpeg',
              '/images/article/m10.jpeg',
              '/images/article/m11.jpeg',
              '/images/article/m12.jpeg',
              '/images/article/m13.jpeg',
              '/images/article/m14.jpeg',
              '/images/article/m15.jpeg',
              '/images/article/m16.jpeg',
              '/images/article/fi1.jpeg',
              '/images/article/fi2.jpeg',
              '/images/article/fi3.jpeg',
              '/images/article/fi4.jpeg',
            ].map((image, index) => (
              <motion.div
                key={index}
